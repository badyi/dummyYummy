...
class RecipeBigCell: RoundedCollectionCellWithShadow {
    ...
    static func heightForCell(with title: String, width: CGFloat) -> CGFloat {
        ...
        let attributedString = NSAttributedString(string: title, attributes: [NSAttributedString.Key.font: BaseRecipeConstants.Cell.Font.titleFont])
...
extension RecipeBigCell {
    ...
    func setupLabels() {
        NSLayoutConstraint.activate([
            titleLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: BaseRecipeConstants.Cell.Layout.leadingSpace),
            titleLabel.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: BaseRecipeConstants.Cell.Layout.topSpace),
            titleLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -BaseRecipeConstants.Cell.Layout.trailingSpace),
            titleLabel.heightAnchor.constraint(greaterThanOrEqualToConstant: BaseRecipeConstants.Cell.Layout.minimalTitleHeight)
        ])
        
        NSLayoutConstraint.activate([
            healthScoreLabel.leadingAnchor.constraint(equalTo: titleLabel.leadingAnchor),
            healthScoreLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: BaseRecipeConstants.Cell.Layout.verticalSpace),
            healthScoreLabel.trailingAnchor.constraint(equalTo: shareButton.leadingAnchor, constant: -BaseRecipeConstants.Cell.Layout.horizontalSpace),
            healthScoreLabel.heightAnchor.constraint(equalToConstant: BaseRecipeConstants.Cell.Layout.healthScoreHeight)
        ])
        
        NSLayoutConstraint.activate([
            minutesLabel.leadingAnchor.constraint(equalTo: titleLabel.leadingAnchor),
            minutesLabel.topAnchor.constraint(equalTo: healthScoreLabel.bottomAnchor, constant: BaseRecipeConstants.Cell.Layout.verticalSpace),
            minutesLabel.trailingAnchor.constraint(equalTo: shareButton.leadingAnchor, constant: -BaseRecipeConstants.Cell.Layout.horizontalSpace),
            minutesLabel.heightAnchor.constraint(equalToConstant: BaseRecipeConstants.Cell.Layout.minutesHeight)
        ])
    }
    ...
    func setupButtons() {
        NSLayoutConstraint.activate([
            ...
            favoriteButton.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -BaseRecipeConstants.Cell.Layout.trailingSpace),
        ...
        NSLayoutConstraint.activate([
            ...
            shareButton.trailingAnchor.constraint(equalTo: favoriteButton.leadingAnchor, constant: -BaseRecipeConstants.Cell.Layout.horizontalSpace),
