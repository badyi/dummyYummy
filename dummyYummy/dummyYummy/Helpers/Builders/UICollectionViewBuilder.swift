...
final class UICollectionViewBuilder {
    ...
    public private(set) weak var delegate: UICollectionViewDelegate?
    public private(set) var dataSource: UICollectionViewDataSource?
...
extension UICollectionViewBuilder {
    ...
    public func build() -> UICollectionView {
        ...
        collectionView.translatesAutoresizingMaskIntoConstraints = translatesAutoresizing
