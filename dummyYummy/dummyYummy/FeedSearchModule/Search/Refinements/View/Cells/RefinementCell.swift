    ...
    func setupView() {
        ...
        NSLayoutConstraint.activate([
            label.topAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.topAnchor,
                                       constant: RefinementsConstants.Cell.Layout.verticalSpace),
            label.leadingAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                                           constant: RefinementsConstants.Cell.Layout.horizontalSpace),
        ...
        NSLayoutConstraint.activate([
            deleteButton.topAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.topAnchor,
                                              constant: RefinementsConstants.Cell.Layout.verticalSpace),
            deleteButton.trailingAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                                                   constant: -RefinementsConstants.Cell.Layout.horizontalSpace),
